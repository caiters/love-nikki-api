 ...
 */
  ...
  var confirmed = function(value, ref, validatingField) {
    ...
    var field = confirmedField
      ...
      : document.querySelector(
          "input[name='" + validatingField + "_confirmation']"
        );
    ...
    if (!field) {
      field = confirmedField
        ...
        : document.querySelector(
            "input[data-vv-name='" + validatingField + "_confirmation']"
          );
    }
  ...
  ErrorBag.prototype.first = function first(field, scope) {
    ...
    for (var i = 0; i < this.errors.length; ++i) {
      if (
        this$1.errors[i].field === field &&
        this$1.errors[i].scope === scope
      ) {
 ...
 */
  ...
  var getInputEventName = function(el) {
    if (
      el.tagName === "SELECT" ||
      ~["radio", "checkbox", "file"].indexOf(el.type)
    ) {
      return "change";
    }
 ...
 */
  ...
  var after = function(moment) {
    return function(value, ref) {
      ...
      return (
        dateValue.isAfter(otherValue) ||
        (inclusion && dateValue.isSame(otherValue))
      );
    };
  };
  ...
  var date_between = function(moment) {
    return function(value, params) {
      ...
      if (params.length > 3) {
        var assign;
        (assign = params), (min = assign[0]), (max = assign[1]), (inclusivity =
          assign[2]), (format = assign[3]);
      } else {
        var assign$1;
        (assign$1 = params), (min = assign$1[0]), (max = assign$1[1]), (format =
          assign$1[2]);
      }
 ...
 */
  Validator.installDateTimeValidators = function installDateTimeValidators(
    ...
    if (typeof moment !== "function") {
      warn(
        "To use the date-time validators you must provide moment reference."
      );
 ...
 */
  Validator.setLocale = function setLocale(language) {
    ...
    if (!DICTIONARY.hasLocale(language)) {
      // eslint-disable-next-line
      warn(
        "You are setting the validator locale to a locale that is not defined in the dicitionary. English messages may still be generated."
      );
    }
 ...
 */
  Validator.prototype._resolveValuesFromGetters = function _resolveValuesFromGetters(
    scope
  ) {
    var this$1 = this;
    if (scope === void 0) scope = "__global__";
    ...
    Object.keys(this.$scopes[scope]).forEach(function(name) {
      ...
      if (
        getter &&
        context &&
        (scope === "__global__" || fieldScope === scope)
      ) {
        var ctx = context();
        if (ctx && ctx.disabled) {
          return;
 ...
 */
  Validator.prototype._createField = function _createField(
    name,
    checks,
    scope
  ) {
 ...
 * @return {Object}
 */
  Validator.prototype._normalizeRules = function _normalizeRules(
    name,
    checks,
    scope,
    field
 ...
 */
  Validator.prototype._normalizeObject = function _normalizeObject(
    rules,
    field
  ) {
 ...
 */
  Validator.prototype._containsValidation = function _containsValidation(
    validations,
    validation
  ) {
 ...
 */
  Validator.prototype._normalizeString = function _normalizeString(
    rules,
    field
  ) {
    var this$1 = this;
 ...
 */
  Validator.prototype._getLocalizedParams = function _getLocalizedParams(
    ...
    if (
      ~["after", "before", "confirmed"].indexOf(rule.name) &&
      rule.params &&
      rule.params[0]
    ) {
      return [
        this.dictionary.getAttribute(LOCALE, rule.params[0], rule.params[0])
      ];
    }
 ...
 */
  Validator.prototype._getFieldDisplayName = function _getFieldDisplayName(
    ...
    return (
      field.as || this.dictionary.getAttribute(LOCALE, field.name, field.name)
    );
  };
 ...
 */
  Validator.prototype.on = function on(name, fieldName, scope, callback) {
    if (!fieldName) {
      throw createError(
        "Cannot add a listener for non-existent field " + fieldName + "."
      );
    }

    if (!isCallable(callback)) {
      throw createError(
        "The " + name + " callback for field " + fieldName + " is not callable."
      );
    }
 ...
 */
  Validator.prototype.off = function off(name, fieldName, scope) {
    if (!fieldName) {
      warn(
        "Cannot remove a listener for non-existent field " + fieldName + "."
      );
    }
  ...
  Validator.prototype._assignFlags = function _assignFlags(field) {
    ...
    this.fieldBag = assign(
      {},
      this.fieldBag,
      ((obj = {}), (obj["$" + field.scope] = scopeObj), obj)
    );
    var obj;
  };
 ...
 */
  Validator.prototype.flag = function flag(name, flags) {
    ...
    Object.keys(field.flags).forEach(function(flag) {
      field.flags[flag] = flags[flag] !== undefined
        ? flags[flag]
        : field.flags[flag];
    });
 ...
 */
  Validator.prototype.updateField = function updateField(
    name,
    checks,
    options
  ) {
 ...
 */
  ...
  Validator.prototype._resolveField = function _resolveField(name, scope) {
    if (name && name.indexOf(".") > -1) {
      ...
      if (!this.$scopes.__global__[name]) {
        var assign$$1;
        (assign$$1 = name.split(".")), (scope = assign$$1[0]), (name =
          assign$$1[1]);
      }
    }
    if (!scope) {
  ...
  Validator.prototype._handleFieldNotFound = function _handleFieldNotFound(
    ...
    throw createError(
      'Validating a non-existant field: "' +
        fullName +
        '". Use "attach()" first.'
    );
  };
 ...
 */
  Validator.prototype._validate = function _validate(field, value) {
    ...
    var promises = [];
    var test = true;
    var syncResult = Object.keys(field.validations)[
      this.fastExit ? "every" : "some"
    ](function(rule) {
      var result = this$1._test(field, value, {
        name: rule,
        params: field.validations[rule]
      });
 ...
 */
  Validator.prototype._setAriaValidAttribute = function _setAriaValidAttribute(
    field,
    valid
  ) {
 ...
 */
  Validator.prototype._setAriaRequiredAttribute = function _setAriaRequiredAttribute(
    field
  ) {
    if (!field.el || field.listeners.component) {
      return;
 ...
 */
  ClassListener.prototype.attach = function attach(field) {
    ...
    this.listeners.after = function(e) {
      this$1.remove(
        e.valid ? this$1.classNames.invalid : this$1.classNames.valid
      );
 ...
 */
  ...
  var ListenerGenerator = function ListenerGenerator(
    el,
    binding,
    vnode,
    options
    ...
    this.el = el;
    this.scope =
      (isObject(binding.value) ? binding.value.scope : getScope(el)) ||
      "__global__";
 ...
 */
  ListenerGenerator.prototype._resolveModel = function _resolveModel(data) {
    ...
    var model =
      data.model ||
      find(data.directives, function(d) {
        return d.name === "model";
      });
    if (!model) {
      return result;
    ...
    result.watchable =
      /^[a-z_]+[0-9]*(\w*\.[a-z_]\w*)*$/i.test(model.expression) &&
 ...
 */
   ...
   */
  ListenerGenerator.prototype._hasFieldDependency = function _hasFieldDependency(
    rules
  ) {
    var this$1 = this;
  ...
  ListenerGenerator.prototype._radioListener = function _radioListener() {
    var checked = document.querySelector(
      'input[name="' + this.el.name + '"]:checked'
    );
   ...
   * From the event.
   */
  ListenerGenerator.prototype._getScopedListener = function _getScopedListener(
    callback
  ) {
    var this$1 = this;
  ...
  ListenerGenerator.prototype._attachValidatorEvent = function _attachValidatorEvent() {
    ...
    var listener = this._getScopedListener(
    ...
    if (fieldName) {
      ...
      this.vm.$nextTick(function() {
        ...
        if (!target) {
          warn(
            "Cannot find target field, no additional listeners were attached."
          );
          return;
        }

        var events =
          getDataAttribute(this$1.el, "validate-on") || this$1.options.events;
 ...
 */
  ...
  ListenerGenerator.prototype._getSuitableListener = function _getSuitableListener() {
    ...
    var events =
      getDataAttribute(this.el, "validate-on") || this.options.events;
    listener.names = events
      .split("|")
      .filter(function(e) {
        return overrides[e] !== null;
      })
      .map(function(e) {
        return overrides[e] || e;
      });
 ...
 */
  ListenerGenerator.prototype._attachComponentListeners = function _attachComponentListeners() {
    ...
    events.split("|").forEach(function(e) {
      ...
      this$1.componentPropUnwatch = this$1.component.$watch(
        "value",
        this$1.componentListener
      );
    });
  };
        ...
        return {
          context: function() {
            return document.querySelectorAll(
              'input[name="' + this$1.el.name + '"]:checked'
            );
          },
 ...
 */
  ListenerGenerator.prototype._attachModelWatcher = function _attachModelWatcher(
    arg
  ) {
    var this$1 = this;
      ...
      if (~["input", "change"].indexOf(name)) {
        var debounced = debounce(function(value) {
          this$1.vm.$validator.validate(
            this$1.fieldName,
            value,
            this$1.scope || getScope(this$1.el)
          );
  ...
  var makeDirective = function(options) {
    return {
      inserted: function inserted(el, ref, ref$1) {
        ...
        var ref$2 = find(listenersInstances, function(l) {
          return l.vm === context && l.el === el;
        });
        var instance = ref$2.instance;
        var scope = isObject(value)
          ? value.scope || getScope(el)
          : getScope(el);
        if (!scope) {
          scope = "__global__";
        }
        if (scope !== instance.scope) {
          var field = context.$validator._resolveField(
            instance.fieldName,
            instance.scope
          );
      ...
      bind: function bind(el, binding, vnode) {
        if (!vnode.context.$validator) {
          ...
          // eslint-disable-next-line
          warn(
            "No validator instance is present on " +
              (name ? 'component "' + name + '"' : "un-named component") +
      ...
      update: function update(el, ref, ref$1) {
        ...
        if (!expression || instance.cachedExp === JSON.stringify(value)) {
          return;
        }
      ...
      unbind: function unbind(el, ref, ref$1) {
        ...
        var holder = find(listenersInstances, function(l) {
          return l.vm === context && l.el === el;
        });
